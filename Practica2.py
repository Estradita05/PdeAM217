 public class PUM
def ReglamentoPOO(self):
 return """Reglamento de programación orientada a objetos:
...
50% más el jefe de grupo, es vigente para todo alumno inscrito en el curso aunque no esté presente en la primera sesión."""
 ...
 def LineamientosClassroom(self):
  return """Lineamientos para el uso de Google Classroom:
  1. Entregar los trabajos para su revisión
  2. Entregas en PDF
  3. Avisos de clase
  4. Entregas autorizadas con retraso, 5 Calif Max."""
 
  def FechasdeParciales(self):
